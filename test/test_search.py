...
def test_search_only_q(db, django_db_setup):
    """This test is to test if the search endpoint
    returns 200 and the data is correct
    """
    # Arrange
...
def test_search_q_plus_include(db, django_db_setup):
    """This test is to test if search endpoint
    return only data with include keyword"""
